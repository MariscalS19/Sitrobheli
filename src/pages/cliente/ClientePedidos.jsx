        ...
        {cargando ? (
          ...
          productosFiltrados.map((prod) => (
            <div key={prod.idProducto} className="cardProducto">
              ...
              <button className="btnAgregar" onClick={() => handleAgregar(prod)}>
                +
              </button>
            </div>
          ))
